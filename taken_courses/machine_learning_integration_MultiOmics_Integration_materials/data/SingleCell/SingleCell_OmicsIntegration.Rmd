...
#options(timeout = 1200)  # the .h5 and .rds files are large; the default 60 s timeout can cut them off

#download.file("https://cf.10xgenomics.com/samples/cell-atac/1.0.1/atac_v1_pbmc_10k/atac_v1_pbmc_10k_singlecell.csv",
 #             destfile = "atac_v1_pbmc_10k_singlecell.csv", mode = "wb")

#download.file("https://cf.10xgenomics.com/samples/cell-atac/1.0.1/atac_v1_pbmc_10k/atac_v1_pbmc_10k_filtered_peak_bc_matrix.h5",
 #             destfile = "atac_v1_pbmc_10k_filtered_peak_bc_matrix.h5", mode = "wb")

#download.file("https://www.dropbox.com/s/3f3p5nxrn5b3y4y/pbmc_10k_v3.rds?dl=1",
 #             destfile = "pbmc_10k_v3.rds", mode = "wb")

#download.file(
#  "https://drive.usercontent.google.com/download?id=1hBeh2L5PC-T87YObCmJv4Qcm59IqkkOf&export=download&confirm=t",
#  destfile = "scatacseq_activity_matrix.txt",
#  mode = "wb"
#)

file.size("scatacseq_activity_matrix.txt")

#Gene activity quantification (ATACseq peaks)
peaks <- Read10X_h5("atac_v1_pbmc_10k_filtered_peak_bc_matrix.h5")
dim(peaks)
peaks[1:5,1:5]
getwd()                              # the folder R is looking in
list.files(pattern = "activity")     # should show scatacseq_activity_matrix.txt
