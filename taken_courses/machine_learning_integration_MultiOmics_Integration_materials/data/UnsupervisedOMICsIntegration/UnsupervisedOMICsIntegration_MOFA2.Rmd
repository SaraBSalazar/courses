...
setwd("C:/Users/ssalazar/OneDrive - FUNDAÇÃO GIMM - GULBENKIAN INSTITUTE FOR MOLECULAR MEDICINE/ADA GIMM/Courses/Taken/Physalia 2026/data/data/UnsupervisedOMICsIntegration")
...
options(reticulate.conda_binary = "C:/Users/ssalazar/AppData/Local/anaconda3/Scripts/conda.exe")
reticulate::use_condaenv("mofa_env", required = TRUE)
library(MOFA2)
...
colnames(scRNAseq)<-ifelse(colnames(scRNAseq)%in%controls,"CONTROL_CELL",colnames(scRNAseq)) # binorization
