...
library("glmnet")
predict
# should print: function (object, ...) UseMethod("predict")
# if it prints something else, that's your bug
...
library(MOFA2)
library(glmnet)   # loaded last -> takes priority in the search list
coef <- stats::predict(lasso_fit, s = "lambda.min", type = "nonzero")
